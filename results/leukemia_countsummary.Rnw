...
library(xtable)
filelist=c("HL60.initial","KBM7.initial","HL60.final","KBM7.final");
labellist=c("HL60.initial","KBM7.initial","HL60.final","KBM7.final");
reads=c(39805888.0,32888001.0,85798957.0,92532640.0);
mappedreads=c(39805888.0,32888001.0,85798957.0,92532640.0);
totalsgrnas=c(73151,73151,73151,73151);
zerocounts=c(609,277,210,451);
giniindex=c(0.07833070713841428,0.07095225271122274,0.06735028927135511,0.08048528347659478);
...
genboxplot("leukemia.count_normalized.txt");
@
...
genhistplot("leukemia.count_normalized.txt");
@
...
genpcaplot("leukemia.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=4.9,height=4.9>>=
genclustering("leukemia.count_normalized.txt");
@
